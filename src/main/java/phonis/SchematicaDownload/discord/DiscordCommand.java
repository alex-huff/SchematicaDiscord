...
public abstract class DiscordCommand {
    ...
    public abstract void handleCommand(MessageReceivedEvent receivedEvent, String[] args) throws DiscordCommandException;
    ...
    protected void assertMemberPermission(Member member, GuildChannel channel, Permission permission) throws DiscordCommandException {
    ...
    protected <E extends Object> E assertNonNull(E element, DiscordCommandException exception) throws DiscordCommandException {
        if (element == null) {
            throw exception;
        }
    ...
    public static class DiscordCommandException extends Exception {
        ...
        public static DiscordCommandException notInGuild = new DiscordCommandException("Use this command in a guild.");
